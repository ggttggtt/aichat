...
CREATE TABLE `user_profile`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `open_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '微信openid',
  `nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '昵称',
  ...
  `bio` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '个人介绍',
  ...
  `is_profile_completed` tinyint(1) NULL DEFAULT 0 COMMENT '是否完善资料',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_open_id`(`open_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户资料表' ROW_FORMAT = DYNAMIC;
